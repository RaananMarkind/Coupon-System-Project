...
//		
		return path.startsWith("/admin") || path.startsWith("/guest") || path.startsWith("/auth")
				|| path.endsWith("/home") || path.endsWith("/guestlallcompanies") || path.endsWith("/guestlallcoupons");
	}
}
