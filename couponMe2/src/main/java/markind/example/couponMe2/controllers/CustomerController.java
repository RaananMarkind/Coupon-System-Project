...
public class CustomerController {
	...
	public CustomerController(HashMap<String, Session> sessions) {
	...
	//---------------------------GETS---------------------------\\
		...
		@GetMapping(path = "/onecoupon/{id}") //v
		public ResponseEntity<?> getOneCoupon(@PathVariable int id, HttpServletRequest req){
			try {
				CustomerFacade customerFacade = getService(req);
