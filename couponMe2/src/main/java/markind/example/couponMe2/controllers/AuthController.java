...
public class AuthController {
	...
	public AuthController(LoginManager loginManager, HashMap<String, Session> sessions) {
		super();
	...
	@PostMapping("/login")
	public ResponseEntity<String> login (@RequestParam String email, @RequestParam String password, @RequestParam String typeUser) {
		ClientType type = ClientType.valueOf(typeUser);
		try {
